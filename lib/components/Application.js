...
export default class Application extends Component {
  ...
  render() {
    ...
    return (
      <div className="Application">
        ...
        />
        <button onClick={this.createUserArray.bind(this)}>Button</button>
      </div>
    )
  }
  ...
  createUserArray() {
    debugger;
    const userArray = this.state.messages.filter((message) => {
      return (message.user.uid === 'srP9VBpzD4S6AesUbXK1il3MIuu2')
    })
    this.setState({messages: userArray});
  }
